...
import { aiGuestBandYFollow, aiGuestContainer, aiGuestSectionX, sectionBgWhite } from "./sectionTheme";
...
export default function ChannelIntegrationStrip() {
  ...
  return (
    <section className={`${sectionBgWhite} ${aiGuestSectionX} ${aiGuestBandYFollow}`}>
