            ...
            <div ref={trackRef} className="flex w-max gap-5">
              {steps.map((s) => (
                ...
                >
                  ...
                  <div className={immersiveCardStyle ? "relative flex-[0.92] shrink-0 bg-white" : ""}>
                    <div
                      className={`relative overflow-hidden ${
                        immersiveCardStyle
                          ? "flex min-h-[11.5rem] flex-col justify-center p-7 md:min-h-[13rem] md:p-9"
                          : "p-6 md:p-7"
                      }`}
                    >
