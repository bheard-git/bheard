...
export async function loadCaseStudyBySlugFromLocal(
  slug: string
): Promise<CaseStudyContent | null> {
  return (
    (caseStudiesData as CaseStudyContent[]).find(
      (study) => study.slug === slug
    ) ?? null
  );
}
export const caseStudiesData: CaseStudyContent[] = [
  {
    "slug": "rodha-edtech",
    "listTitle": "Rodha",
    "listTagline": "Building a scalable academic support platform.",
    "listDescription": "An enterprise-grade EdTech platform connecting students, mentors, and administrators in one ecosystem.",
    "listMeta": "EdTech Platform Development · Doubt Resolution System · Exam Preparation",
    "listImage": "/assets/work/rodha%20case%20study-compressed.jpg",
    ...
    "execution": [
      {
        ...
        "image": "/assets/work/rodha%20case%20study-compressed.jpg",
        "imageAlt": "Building a Scalable",
        "align": "left"
      }
    ],
    "results": {
      ...
      "stats": [
        ...
        {
          "value": "Unified",
          "label": "Student-mentor-admin workflow"
        }
      ],
      "closing": "Enabled real-time doubt management, automated workflows, and performance monitoring through dedicated role-based platforms."
    },
    "impactItems": [
      {
        "icon": "users",
      ...
      },
      {
        ...
        "value": "Unified",
        "title": "Workflow",
        "description": "Created a unified academic support workflow connecting students, mentors, and administrators within a single ecosystem."
      },
      {
        "icon": "sparkles",
        "value": "Scalable",
        "title": "Foundation",
        "description": "Established a scalable foundation for Rodha's future growth and expanding student community. [Explore EdTech](/industries/education-edtech).",
        "href": "/industries/education-edtech",
        "hrefLabel": "EdTech"
      }
    ],
    "closingStatement": "By connecting students, mentors, and administrators in one ecosystem, Rodha now has a platform built to scale with its community.",
    "cta": {
  ...
  },
  {
    ...
    "results": {
      ...
      "stats": [
        {
          "value": "4M+",
          "label": "\"Fittest at 55\" impressions"
        },
        {
          "value": "10+",
          "label": "Milestone campaigns executed"
        },
        {
          "value": "Multi-platform",
          "label": "IG, Facebook & LinkedIn"
        }
      ],
      "closing": "Instagram, Facebook and LinkedIn presence built and managed from the ground up for one of India's most recognised wellness personalities."
    },
    "impactItems": [
      {
        "icon": "chart",
      ...
      },
      {
        ...
        "value": "Multi-Platform",
        "title": "Presence",
        "description": "Instagram, Facebook and LinkedIn presence built and managed from the ground up for one of India's most recognised wellness personalities."
      }
    ],
    "extraSections": [
      {
    ...
    "closingStatement": "For wellness brands, credibility is earned over time. Our focus has always been on helping experts turn their knowledge into influence, and their influence into lasting communities.",
    "cta": {
      "title": "Let's build what's next",
  ...
  },
  {
    ...
    "listDescription": "Destination-led storytelling that shifted perception and showcased Goa as a year-round experience.",
    "listMeta": "Destination Marketing · Campaign Strategy · Digital Content",
    "listImage": "/assets/work/goa%20tourism%20case%20study-compressed.jpg",
    ...
    "heroSubtitle": "The strongest destinations aren't promoted through attractions alone, they're built through stories that inspire people to visit, stay longer, and return. For many travellers, Goa is defined by a familiar set of images: beaches, nightlife, and year-end holidays.\n\nWorking alongside the Travel & Tourism Association of Goa and Goa Tourism, we helped build a destination-led platform created to showcase a different side of Goa through culture, food, wellness, festivals, and local experiences that exist throughout the year.",
    "heroMeta": "Destination Marketing",
    "heroImage": "/assets/work/goa%20tourism%20case%20study-compressed.jpg",
    ...
    "execution": [
      {
        ...
        "image": "/assets/work/goa%20tourism%20case%20study-compressed.jpg",
        "imageAlt": "Reframing Goa",
        "align": "left"
      }
    ],
    "results": {
      ...
      "closing": "12K+ interactions driven through seasonal storytelling and stakeholder-led campaigns, outperforming typical destination marketing benchmarks."
    },
    "impactItems": [
      {
        "icon": "globe",
  ...
  },
  {
    ...
    "listDescription": "A mobile application that brought food, travel, lifestyle, and local experiences into a single discovery ecosystem.",
    "listMeta": "Mobile App Development · Content Experience Platform · Travel & Lifestyle Discovery",
    "listImage": "/assets/work/Curly%20tales%20case%20study-compressed.jpg",
    ...
    "heroSubtitle": "As brands evolve, websites and social media channels are no longer enough to own the customer experience. Mobile applications and digital products enable brands to build deeper engagement, create direct relationships with users, and unlock new opportunities for growth.\n\nOne such example is our work with Curly Tales, one of India's most recognisable food, travel, and lifestyle media brands.",
    "heroMeta": "Product & App Development",
    "heroImage": "/assets/work/Curly%20tales%20case%20study-compressed.jpg",
    ...
    "execution": [
      {
        ...
        "image": "/assets/work/Curly%20tales%20case%20study-compressed.jpg",
        "imageAlt": "Building Digital Products That Create",
        "align": "left"
      }
    ],
    "results": {
      ...
      "closing": "Successfully transformed Curly Tales from a content-first platform into a mobile-first experience, strengthening audience engagement beyond traditional social media channels."
    },
    "impactItems": [
      {
        "icon": "sparkles",
      ...
      },
      {
        ...
        "value": "Unified",
        "title": "Discovery",
        "description": "Created a dedicated destination for food, travel, lifestyle, and local experience discovery."
      },
      {
        "icon": "trending",
        "value": "Scalable",
        "title": "Foundation",
        "description": "Established a scalable digital product capable of supporting future platform expansion."
      }
    ],
    "extraSections": [
      {
    ...
    "closingStatement": "By helping Curly Tales create a dedicated mobile experience, we enabled the brand to move closer to its audience—transforming inspiration into discovery through a platform designed for how people explore today.",
    "cta": {
      "title": "Let's build what's next",
  ...
  },
  {
    ...
    "listDescription": "Community-led content and Meta performance marketing that turned brand affinity into measurable e-commerce sales.",
    "listMeta": "India Market Entry Strategy · Brand Positioning · Digital Marketing",
    "listImage": "/assets/work/zumba%20forever%20case%20study-compressed.jpg",
    ...
    "execution": [
      {
        ...
        "image": "/assets/work/zumba%20forever%20case%20study-compressed.jpg",
        "imageAlt": "Building a Global Lifestyle Brand's Community",
        "align": "left"
      }
    ],
    "results": {
      ...
      "stats": [
        {
          "value": "23.3K",
          "label": "Instagram followers (from 1.5K)"
        },
        {
          "value": "274+",
          "label": "Facebook ad purchases in one year"
        },
        {
          "value": "15%+",
          "label": "Website traffic from Facebook"
        }
      ],
      "closing": "Peak monthly engagement rate of 19% on Facebook, with Instagram engagement reaching 5.38%. 5.5 lakh+ Facebook page reach and 6.7 lakh+ impressions in a single quarter."
    },
    "impactItems": [
      {
        "icon": "users",
      ...
      },
      {
        ...
        "description": "Peak monthly engagement rate on Facebook, with Instagram engagement reaching 5.38%. Over 15% of all website traffic driven by Facebook alone."
      }
    ],
    "closingStatement": "By combining community storytelling with performance marketing, we helped a global lifestyle brand find its voice in India — proving that when content builds belonging, commerce follows. [Explore consumer & FMCG work](/industries/consumer-fmcg).",
    "cta": {
      "title": "Let's build what's next",
  ...
  },
  {
    ...
    "listDescription": "A digital strategy that turned social media into a reliable channel for engagement, enquiries, and guest consideration.",
    "listMeta": "Social Media Strategy · Content Production · Performance Campaigns",
    "listImage": "/assets/work/Hospitality%20case%20study.jpg",
    ...
    "execution": [
      {
        ...
        "image": "/assets/work/Hospitality%20case%20study.jpg",
        "imageAlt": "Building a Digital Growth Engine",
        "align": "left"
      }
    ],
    "results": {
      ...
      "stats": [
        ...
        {
          "value": "2X",
          "label": "Lead growth in two months"
        },
        {
          "value": "AI-led",
          "label": "Guest engagement via Guest AI"
        }
      ],
      "closing": "Engagement increased from 108,433 to 329,673 during a high-performing seasonal campaign period, with 2X lead growth achieved within two months through campaign optimisation and performance marketing."
    },
    "impactItems": [
      {
        "icon": "chart",
        ...
        "description": "Increasing from 108,433 to 329,673 engagements during a high-performing seasonal campaign period."
      },
      {
        "icon": "users",
        "value": "2X",
    ...
    "closingStatement": "By combining audience-first content, performance marketing, and hospitality-focused technology, we helped Radisson Blu strengthen its digital presence while creating a more connected experience for today's traveller. [Learn more about our hospitality expertise](/industries/hospitality-luxury).",
    "cta": {
      "title": "Let's build what's next",
