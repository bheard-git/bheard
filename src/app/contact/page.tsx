    ...
    <section className="section-spacing">
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div>
            <h1 className="text-h1 font-bold">Get in <span className="text-gradient-orange">Touch</span></h1>
            <p className="mt-4 text-body-lg text-text-muted">
              Have questions? We&apos;d love to hear from you. Send us a message and we&apos;ll respond as soon as possible.
            </p>
            <div className="mt-8 space-y-4">
              <div className="flex items-center gap-3 text-text-secondary">
                <span className="w-10 h-10 rounded-lg bg-bg-surface flex items-center justify-center text-orange-400">
