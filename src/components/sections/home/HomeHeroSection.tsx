...
const HERO_CONTENT_MAX = "max-w-[26rem] sm:max-w-[28rem]";

export function HomeHeroSection() {
  return (
    <HomeHeroShell>
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-6 xl:gap-8 items-center min-h-0">
          <div className={`lg:col-span-6 min-h-0 ${HERO_CONTENT_MAX} lg:max-w-none`}>
            <div className={HERO_CONTENT_MAX}>
              <h1 className="text-[32px] sm:text-[38px] md:text-[40px] lg:text-[42px] font-bold leading-[1.15] tracking-tight">
                Expert Mentorship. Proven Strategies.{" "}
          ...
          <div className="lg:col-span-6 flex flex-col items-center min-h-0 lg:pl-2 xl:pl-4">
            <div className="flex w-full flex-col gap-2.5 sm:gap-3 overflow-visible px-2 sm:px-4 lg:px-6">
              <HeroVideoEmbed />
              <HeroFloatingStats />
              <HeroTrustMetrics />
            </div>
