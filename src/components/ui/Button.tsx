...
const variants = {
  primary:
    "btn-primary-premium premium-border-glow glow-accent-orange bg-orange-500 text-white hover:bg-orange-600 hover:shadow-orange hover:-translate-y-px active:translate-y-0 active:bg-orange-700 disabled:hover:bg-orange-500",
  secondary:
